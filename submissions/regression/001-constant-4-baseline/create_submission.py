#!/usr/bin/env python3
"""Create the constant-4.0 OpenADMET CYP regression submission."""
...
def main() -> int:
    ...
    output = args.output_dir / (
        f"openadmet-cyp_regression-sub_dargason_{args.timestamp}.csv"
    )
            ...
            writer.writerow(
                {
                    ...
                    **{endpoint: 4.0 for endpoint in ENDPOINTS},
                }
            )
